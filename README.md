...
Иногда осциллограф сохраняет скриншоты с чёрным фоном — в отчётах такие картинки плохо читаются и тратят много краски при печати. Этот мини-скрипт инвертирует цвета картинок внутри `.docx`, чтобы получать светлые, удобные для полиграфии версии отчётов.
